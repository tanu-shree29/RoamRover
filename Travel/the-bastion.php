                ...
                <div class="browse-r">
                    <div class="browse-r-body">
                            ...
                            <div class="top">
                                <div class="tleft">
                                   <h1>The Bastion</h1>
                                  <img src="assets\hotels\the_bastion.webp" alt="the-bastion img">
                               </div>
                               <div class="tright">
                               Close to Aura Mall, this modern property makes for
                                a relaxing stay option with its stylish rooms, a dining 
                                venue and easy access to popular areas of the city.
                               </div>
                            ...
                            <div class="middle">
                                <div class="mleft">
                                    ...
                                    <div class="but">
                                        <button class="click">
                                        <a href="bastion-rooms.php">Click here</a>
                                        </button>
                                    </div>
                                    </div>
                                ...
                                <div class="mright">
                                    <img src="assets\hotels\executive.webp" alt="room-img">
                                </div>
                            ...
                            <div class="bottom">
                                ...
                                <div class="bright">
                                    <ul>
                                        <li>
                                        Raja Bhoj International Airport is 21.3 km away from the property.
                                        </li>
                                        <li>
                                        Bhopal Junction Railway Station is 10.1 km away from the property.
                                        </li>
                                        <li>
                                        Bhopal Bus Stand is 10.4 km away from the property.
                                        </li>
                                    </ul>
