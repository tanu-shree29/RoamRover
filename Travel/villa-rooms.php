        ...
        <div class="browse-page">
            ...
            <div class="browse-r-wrapper">
                <div class="browse-r">
                    ...
                    <?php
                        include('conf.php');
                        $query1 = "SELECT * FROM rooms WHERE hotel_id = '104' and type_id = '10'";
                        $query2 = "SELECT * FROM rooms WHERE hotel_id = '104' and type_id = '11'";
                        // $query3 = "SELECT * FROM rooms WHERE hotel_id = '104' and type_id = '03'";
                    ...
                    ?>
                            ...
                            <div class="top">
                                <div class="tleft">
                                   ...
                                   ?></h1>
                                  <img src="assets\hotels\private_patio.webp" alt="the-bastion img">
                               </div>
                               <div class="tright2">
                              <ul>
                                <li>
                            ...
                            <div class="middle">
                                ...
                                <div class="mright2">
                                    <img src="assets\hotels\rustic_cottage.jpg" alt="room-img">
                                </div>
