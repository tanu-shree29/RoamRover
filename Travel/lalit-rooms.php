        ...
        <div class="browse-page">
            ...
            <div class="browse-r-wrapper">
                <div class="browse-r">
                    ...
                    <?php
                        include('conf.php');
                        $query1 = "SELECT * FROM rooms WHERE hotel_id = '103' and type_id = '06'";
                        $query2 = "SELECT * FROM rooms WHERE hotel_id = '103' and type_id = '07'";
                        $query3 = "SELECT * FROM rooms WHERE hotel_id = '103' and type_id = '08'";
                    ...
                    ?>
                            ...
                            <div class="top">
                                <div class="tleft">
                                   ...
                                   ?></h1>
                                  <img src="assets\hotels\business_suite.jpg" alt="the-bastion img">
                               </div>
                               <div class="tright2">
                              <ul>
                                <li>
                            ...
                            <div class="middle">
                                ...
                                <div class="mright2">
                                    <img src="assets\hotels\Corner-suite.jpg" alt="room-img">
                                </div>
                            ...
                            <div class="bottom">
                                <div class="bleft">
                                   ...
                                   ?></h1>
                                    <img src="assets\hotels\deluxe-room-king.jpg" alt="reach">
                                </div>
                                <div class="bright2">
                                    <ul>
                                        <li>
