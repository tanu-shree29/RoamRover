                ...
                <div class="browse-r">
                    <div class="browse-r-body">
                            ...
                            <div class="top">
                                <div class="tleft">
                                   <h1>The LaLiT</h1>
                                  <img src="assets\hotels\tht_lalit.webp" alt="the-bastion img">
                               </div>
                               <div class="tright">
                               Located in Central Delhi, The Lalit is 
                               acclaimed for its fine dining, art works, 
                               classy decor, and luxury living.
                               </div>
                            ...
                            <div class="middle">
                                <div class="mleft">
                                    ...
                                    <div class="but">
                                        <button class="click">
                                        <a href="lalit-rooms.php">Click here</a>
                                        </button>
                                    </div>
                                    </div>
                                ...
                                <div class="mright">
                                    <img src="assets\hotels\business_suite.jpg" alt="room-img">
                                </div>
                            ...
                            <div class="bottom">
                                ...
                                <div class="bright">
                                    <ul>
                                        <li>
                                        New Delhi Metro Station and New Delhi Railway Station are both 2 km away.
                                        </li>
                                        <li>
                                        The hotel is 15 km away from Indira Gandhi International Airport.
                                        </li>
                                        <!-- <li>
