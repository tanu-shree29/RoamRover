        ...
        <div class="browse-page">
            ...
            <div class="browse-r-wrapper">
                <div class="browse-r">
                    ...
                    <?php
                        include('conf.php');
                        $query1 = "SELECT * FROM rooms WHERE hotel_id = '106' and type_id = '15'";
                        $query2 = "SELECT * FROM rooms WHERE hotel_id = '106' and type_id = '16'";
                        $query3 = "SELECT * FROM rooms WHERE hotel_id = '106' and type_id = '17'";
                    ...
                    ?>
                            ...
                            <div class="top">
                                <div class="tleft">
                                   ...
                                   ?></h1>
                                  <img src="assets\hotels\grande-room.webp" alt="the-bastion img">
                               </div>
                               <div class="tright2">
                              <ul>
                                <li>
                            ...
                            <div class="middle">
                                ...
                                <div class="mright2">
                                    <img src="assets\hotels\junior-suite.webp" alt="room-img">
                                </div>
                            ...
                            <div class="bottom">
                                <div class="bleft">
                                   ...
                                   ?></h1>
                                    <img src="assets\hotels\standard-ac.webp" alt="reach">
                                </div>
                                <div class="bright2">
                                    <ul>
                                        <li>
