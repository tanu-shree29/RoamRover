        ...
        <div class="browse-page">
                    ...
                    <div class="easy-ac-body">
                        ...
                        <?php
                            if(isset($_SESSION['is_logged_in'])){
                                echo '<div class="tile">
                                    <div class="tile-img">
                                        <img src="./assets/tile-mybookings.jpg" alt="tile-mybookings" class="tile-icon">
                                    </div>
                                    <div class="tile-cont">
                                        <div class="tile-head"> 
                                            My Bookings
            ...
            <div class="browse-r-wrapper">
                <div class="browse-r">
                    ...
                    <?php
                        include('conf.php');
                        $query1 = "SELECT * FROM rooms WHERE hotel_id = '102' and type_id = '04'";
                        $query2 = "SELECT * FROM rooms WHERE hotel_id = '102' and type_id = '05'";
                    ...
                    ?>
                            ...
                            <div class="top">
                                <div class="tleft">
                                   ...
                                   ?></h1>
                                  <img src="assets\hotels\executive.webp" alt="the-bastion img">
                               </div>
                               <div class="tright2">
                              <ul>
                                <li>
                            ...
                            <div class="middle">
                                ...
                                <div class="mright2">
                                    <img src="assets\hotels\premimum.jpg" alt="room-img">
                                </div>
                            ...
                            <!-- <div class="bottom">
                                <div class="bleft">
                                    <h1>Junior suite</h1>
                                    <img src="assets\hotels\junior-suite.webp" alt="reach">
                                </div>
                                <div class="bright2">
                                    <ul>
                                        <li>
