        ...
        <div class="browse-page">
            ...
            <div class="browse-r-wrapper">
                <div class="browse-r">
                    ...
                    <?php
                        include('conf.php');
                        $query1 = "SELECT * FROM rooms WHERE hotel_id = '105' and type_id = '12'";
                        $query2 = "SELECT * FROM rooms WHERE hotel_id = '105' and type_id = '13'";
                        $query3 = "SELECT * FROM rooms WHERE hotel_id = '105' and type_id = '14'";
                    ...
                    ?>
                            ...
                            <div class="top">
                                <div class="tleft">
                                   ...
                                   ?></h1>
                                  <img src="assets\hotels\club-room.webp" alt="the-bastion img">
                               </div>
                               <div class="tright2">
                              <ul>
                                <li>
                            ...
                            <div class="middle">
                                ...
                                <div class="mright2">
                                    <img src="assets\hotels\day-use-room.jpg" alt="room-img">
                                </div>
                            ...
                            <div class="bottom">
                                <div class="bleft">
                                   ...
                                   ?></h1>
                                    <img src="assets\hotels\deluxe-private-room.webp" alt="reach">
                                </div>
                                <div class="bright2">
                                    <ul>
                                        <li>
